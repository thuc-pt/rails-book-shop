...
class SlidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post slides_url, params: { slide: { link_slide_id: @slide.link_slide_id, url_img: @slide.url_img } }
    end
  ...
  test "should update slide" do
    patch slide_url(@slide), params: { slide: { link_slide_id: @slide.link_slide_id, url_img: @slide.url_img } }
